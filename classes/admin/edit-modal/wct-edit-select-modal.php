...
?>
<div id="ossvn-edit-select-modal" class="ossvn-modal ossvn-block-modal uk-modal">
	<div class="uk-modal-dialog ossvn-modal-box">
		...
		<div class="ossvn-modal-body uk-form">
			<ul class="uk-tab" data-uk-switcher="{connect:'#ossvn-select-general'}">
			    <li class="uk-active"><a href=""><?php _e('General', 'wct');?></a></li>
			    <li><a href=""><?php _e('Advanced', 'wct');?></a></li>
			</ul>
			<ul id="ossvn-select-general" class="uk-switcher uk-margin">
				<li>
					...
					<div class="ossvn-form-group">
						<label class="ossvn-label" for="ossvn-checkbox-class"><?php _e('Options', 'wct');?></label>
						...
						<p><?php _e('option-1 : Option 1', 'wct');?><br><?php _e('option-2 : Option 2', 'wct');?></p>
					</div>
					<div class="ossvn-form-group">
						<label class="ossvn-label" for="ossvn-checkbox-id-select-1"><?php _e('Multiple select?', 'wct');?></label>
						<input type="checkbox" id="ossvn-checkbox-id-select-1" data-target="multiple_select" class="ossvn-get-data"/>
					</div>
					<div class="ossvn-form-group">
						<label class="ossvn-label" for="ossvn-checkbox-id-select-1"><?php _e('Remove empty option?', 'wct');?></label>
						<input type="checkbox" id="ossvn-checkbox-id-select-1" data-target="remove_empty_option" class="ossvn-get-data"/>
					</div>
					<div class="ossvn-form-group">
						<label class="ossvn-label" for="ossvn-checkbox-id-select-2"><?php _e('Required', 'wct');?></label>
						<input type="checkbox" id="ossvn-checkbox-id-select-2" data-target="block_required" class="ossvn-get-data"/>
					</div>
					<div class="ossvn-form-group show_if_custom_fields">
						<label class="ossvn-label" for="ossvn-checkbox-id-select-3"><?php _e('Display in order recived  ', 'wct');?></label>
						<input type="checkbox" id="ossvn-checkbox-id-select-3" data-target="block_display_order_recived" class="ossvn-get-data"/>
					</div>
					<div class="ossvn-form-group show_if_custom_fields">
						<label class="ossvn-label" for="ossvn-checkbox-id-select-4"><?php _e('Display in email order  ', 'wct');?></label>
						<input type="checkbox" id="ossvn-checkbox-id-select-4" data-target="block_display_email" class="ossvn-get-data"/>
					</div>
				...
				<li>
					...
					<div class="ossvn-price ossvn-form-group">
						<label class="ossvn-label" for="ossvn-checkbox-class-select-5"><?php _e('Price', 'wct');?></label>
						<input type="checkbox" id="ossvn-checkbox-class-select-5"  data-target="block_price" class="ossvn-get-data" /><input type="text" id="ossvn-block-price-value"  data-target="block_price_value" class="ossvn-get-data" placeholder="<?php _e('Add price','wct');?>" style="display:none;margin-left:20px;"/>
					</div>
					<?php 
					/**
